...
ren (UF V0302 V8005 V0404 V4803 V4718 V4729 V4722 V4724 V0501 V0601 V0701 V4704 V4805 V9058) ///
	(uf sexo idade raca educ renda peso ren_fam componentes migrante analfabeto infantil ativ ocup horas)
...
keep if raca == 2 | raca == 4 | raca == 8
gen branco = raca ==2
gen nbranco = branco == 0
...
gen migra = migrante == 3 & !missing(migrante)

gen nmigra = migrante == 1 & !missing(migrante)


save "$data\pnad_mod.dta", replace
